        ...
        <div id="app" v-cloak>
            <div class="register-box">
                ...
                <div class="register-box-body">
                    <p class="login-box-msg">{{ __('adminlang.registermember') }}</p>
                    <form action="{{ url('/register') }}" method="post">
                        ...
                        @if (config('auth.providers.users.field', 'email') === 'username')
                            <div class="form-group has-feedback">
                                <input type="text" class="form-control" placeholder="{{ __('adminlang.username') }}"
                        ...
                        <div class="form-group has-feedback">
                            <input type="password" class="form-control" placeholder="{{ __('adminlang.retrypepassword') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4 col-xs-push-1">
                                <button type="submit"
                                    class="btn btn-primary btn-block btn-flat">{{ __('adminlang.register') }}</button>
                            </div><!-- /.col -->
                        </div>
                    </form>
                    ...
                    <a href="{{ url('/login') }}" class="text-center">{{ __('adminlang.membership') }}</a>
                </div><!-- /.form-box -->
            </div><!-- /.register-box -->
        </div>
