                            ...
                            <td class="dropdown text-center">
                                ...
                                <div class="dropdown-menu p-0">
                                    @can('DistrictController@show')
                                        <a href="{{ url('/admin/districts/' . $item->id) }}"
                                            title="{{ __('Xem') }}"><button class="btn btn-info dropdown-item"><i
                                                    class="fas fa-eye"></i> {{ __('message.user.view_user') }}</button></a>
                                    @endcan
                                    @can('DistrictController@update')
                                        <a href="{{ url('/admin/districts/' . $item->id . '/edit') }}"
