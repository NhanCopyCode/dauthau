        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
            ...
            <header
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open"
                            class="flex items-center gap-3 px-2 py-1.5 hover:bg-zinc-800 rounded-lg transition-colors">
                            <div
                            ...
                            <div class="text-left hidden sm:block">
                                <p class="text-sm font-medium text-zinc-100">Admin</p>
                                <p class="text-xs text-zinc-500">Quản trị viên</p>
                            </div>
                        ...
                        <div x-show="open" @click.away="open = false"
                            ...
                            <div class="p-3 border-b border-zinc-800">
                                <p class="text-sm font-medium text-zinc-100">admin@dauthau.gov.vn</p>
                                <p class="text-xs text-zinc-500 mt-0.5">Super Administrator</p>
                            </div>
                            <div class="py-1">
                                <a href="#"
                                    class="flex items-center gap-3 px-3 py-2 text-sm text-zinc-300 hover:text-zinc-100 hover:bg-zinc-800/50">
                            ...
                            <div class="py-1 border-t border-zinc-800">
                                <a href="#"
                                    class="flex items-center gap-3 px-3 py-2 text-sm text-red-400 hover:text-red-300 hover:bg-zinc-800/50">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="grid grid-cols-2 lg:grid-cols-5 gap-4">
                        ...
                        <div class="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
                            <div class="flex items-center justify-between">
                                <span class="text-xs font-medium text-zinc-500 uppercase tracking-wide">Tổng thu
                                    thập</span>
                            ...
                            <p class="mt-3 text-2xl font-bold text-zinc-100 font-mono">24,532</p>
                            <p class="mt-1 text-xs text-zinc-500">+1,247 tuần này</p>
                        </div>
                        ...
                        <div class="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
                            ...
                            <p class="mt-3 text-2xl font-bold text-zinc-100 font-mono">352</p>
                            <p class="mt-1 text-xs text-emerald-500">+12.5% so với hôm qua</p>
                        </div>
                        ...
                        <div class="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
                            ...
                            <p class="mt-3 text-2xl font-bold text-zinc-100 font-mono">3m 42s</p>
                        ...
                        <div class="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
                            ...
                            <p class="mt-3 text-lg font-semibold text-emerald-500">Thành công</p>
                            <p class="mt-1 text-xs text-zinc-500">10:45 AM hôm nay</p>
                        </div>
                        ...
                        <div class="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
                            ...
                            <p class="mt-3 text-2xl font-bold text-zinc-100 font-mono">12</p>
